...
"""Código para ajudar a gerar as vendas aleátorias para a atividade. quem não tem o módulo random instalado vai no terminal e instala com o comando
...
print(venda_insert) # Vai retornar no terminal a lista de vendas pronta para ser levada pro código da query de insert. 
